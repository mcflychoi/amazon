 ...
 *
 */
class Client implements ReportInterface
{
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportRequest request
   * or \Amazon\Reports\Model\GetReportRequest object itself
   * @see \Amazon\Reports\Model\GetReport
   * @return \Amazon\Reports\Model\GetReportResponse \Amazon\Reports\Model\GetReportResponse
   *
   * @throws AmazonException
   */
  public function getReport($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportRequest) 
    {
      $request = new \Amazon\Reports\Model\GetReportRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetReport($request), $request->getReport());
    $response = \Amazon\Reports\Model\GetReportResponse::fromXML($httpResponse['ResponseBody']);
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportScheduleCountRequest request
   * or \Amazon\Reports\Model\GetReportScheduleCountRequest object itself
   * @see \Amazon\Reports\Model\GetReportScheduleCount
   * @return \Amazon\Reports\Model\GetReportScheduleCountResponse \Amazon\Reports\Model\GetReportScheduleCountResponse
   *
   * @throws AmazonException
   */
  public function getReportScheduleCount($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportScheduleCountRequest) {
      $request = new \Amazon\Reports\Model\GetReportScheduleCountRequest($request);
    }
   
    $httpResponse = $this->invoke($this->convertGetReportScheduleCount($request));
    $response = \Amazon\Reports\Model\GetReportScheduleCountResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportRequestListByNextTokenRequest request
   * or \Amazon\Reports\Model\GetReportRequestListByNextTokenRequest object itself
   * @see \Amazon\Reports\Model\GetReportRequestListByNextToken
   * @return \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse
   *
   * @throws AmazonException
   */
  public function getReportRequestListByNextToken($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportRequestListByNextTokenRequest) {
      $request = new \Amazon\Reports\Model\GetReportRequestListByNextTokenRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetReportRequestListByNextToken($request));
    $response = \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\UpdateReportAcknowledgementsRequest request
   * or \Amazon\Reports\Model\UpdateReportAcknowledgementsRequest object itself
   * @see \Amazon\Reports\Model\UpdateReportAcknowledgements
   * @return \Amazon\Reports\Model\UpdateReportAcknowledgementsResponse \Amazon\Reports\Model\UpdateReportAcknowledgementsResponse
   *
   * @throws AmazonException
   */
  public function updateReportAcknowledgements($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\UpdateReportAcknowledgementsRequest) {
      $request = new \Amazon\Reports\Model\UpdateReportAcknowledgementsRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertUpdateReportAcknowledgements($request));
    $response = \Amazon\Reports\Model\UpdateReportAcknowledgementsResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\SubmitFeedRequest request
   * or \Amazon\Reports\Model\SubmitFeedRequest object itself
   * @see \Amazon\Reports\Model\SubmitFeed
   * @return \Amazon\Reports\Model\SubmitFeedResponse \Amazon\Reports\Model\SubmitFeedResponse
   *
   * @throws AmazonException
   */
  public function submitFeed($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\SubmitFeedRequest) {
      $request = new \Amazon\Reports\Model\SubmitFeedRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertSubmitFeed($request), $request->getFeedContent());
    $response = \Amazon\Reports\Model\SubmitFeedResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportCountRequest request
   * or \Amazon\Reports\Model\GetReportCountRequest object itself
   * @see \Amazon\Reports\Model\GetReportCount
   * @return \Amazon\Reports\Model\GetReportCountResponse \Amazon\Reports\Model\GetReportCountResponse
   *
   * @throws AmazonException
   */
  public function getReportCount($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportCountRequest) {
      $request = new \Amazon\Reports\Model\GetReportCountRequest($request);
    }
   
    $httpResponse = $this->invoke($this->convertGetReportCount($request));
    $response = \Amazon\Reports\Model\GetReportCountResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenRequest request
   * or \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenRequest object itself
   * @see \Amazon\Reports\Model\GetFeedSubmissionListByNextToken
   * @return \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse
   *
   * @throws AmazonException
   */
  public function getFeedSubmissionListByNextToken($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenRequest) {
      $request = new \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetFeedSubmissionListByNextToken($request));
    $response = \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\CancelFeedSubmissionsRequest request
   * or \Amazon\Reports\Model\CancelFeedSubmissionsRequest object itself
   * @see \Amazon\Reports\Model\CancelFeedSubmissions
   * @return \Amazon\Reports\Model\CancelFeedSubmissionsResponse \Amazon\Reports\Model\CancelFeedSubmissionsResponse
   *
   * @throws AmazonException
   */
  public function cancelFeedSubmissions($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\CancelFeedSubmissionsRequest) {
      $request = new \Amazon\Reports\Model\CancelFeedSubmissionsRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertCancelFeedSubmissions($request));
    $response = \Amazon\Reports\Model\CancelFeedSubmissionsResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\RequestReportRequest request
   * or \Amazon\Reports\Model\RequestReportRequest object itself
   * @see \Amazon\Reports\Model\RequestReport
   * @return \Amazon\Reports\Model\RequestReportResponse \Amazon\Reports\Model\RequestReportResponse
   *
   * @throws AmazonException
   */
  public function requestReport($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\RequestReportRequest) 
    {
      $request = new \Amazon\Reports\Model\RequestReportRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertRequestReport($request));
    $response = \Amazon\Reports\Model\RequestReportResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetFeedSubmissionCountRequest request
   * or \Amazon\Reports\Model\GetFeedSubmissionCountRequest object itself
   * @see \Amazon\Reports\Model\GetFeedSubmissionCount
   * @return \Amazon\Reports\Model\GetFeedSubmissionCountResponse \Amazon\Reports\Model\GetFeedSubmissionCountResponse
   *
   * @throws AmazonException
   */
  public function getFeedSubmissionCount($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetFeedSubmissionCountRequest) {
      $request = new \Amazon\Reports\Model\GetFeedSubmissionCountRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetFeedSubmissionCount($request));
    $response = \Amazon\Reports\Model\GetFeedSubmissionCountResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\CancelReportRequestsRequest request
   * or \Amazon\Reports\Model\CancelReportRequestsRequest object itself
   * @see \Amazon\Reports\Model\CancelReportRequests
   * @return \Amazon\Reports\Model\CancelReportRequestsResponse \Amazon\Reports\Model\CancelReportRequestsResponse
   *
   * @throws AmazonException
   */
  public function cancelReportRequests($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\CancelReportRequestsRequest) {
      $request = new \Amazon\Reports\Model\CancelReportRequestsRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertCancelReportRequests($request));
    $response = \Amazon\Reports\Model\CancelReportRequestsResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportListRequest request
   * or \Amazon\Reports\Model\GetReportListRequest object itself
   * @see \Amazon\Reports\Model\GetReportList
   * @return \Amazon\Reports\Model\GetReportListResponse \Amazon\Reports\Model\GetReportListResponse
   *
   * @throws AmazonException
   */
  public function getReportList($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportListRequest) {
      $request = new \Amazon\Reports\Model\GetReportListRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetReportList($request), $dataHandle);
    $response = \Amazon\Reports\Model\GetReportListResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetFeedSubmissionResultRequest request
   * or \Amazon\Reports\Model\GetFeedSubmissionResultRequest object itself
   * @see \Amazon\Reports\Model\GetFeedSubmissionResult
   * @return \Amazon\Reports\Model\GetFeedSubmissionResultResponse \Amazon\Reports\Model\GetFeedSubmissionResultResponse
   *
   * @throws AmazonException
   */
  public function getFeedSubmissionResult($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetFeedSubmissionResultRequest) {
      $request = new \Amazon\Reports\Model\GetFeedSubmissionResultRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetFeedSubmissionResult($request), $request->getFeedSubmissionResult());
    $response = \Amazon\Reports\Model\GetFeedSubmissionResultResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetFeedSubmissionListRequest request
   * or \Amazon\Reports\Model\GetFeedSubmissionListRequest object itself
   * @see \Amazon\Reports\Model\GetFeedSubmissionList
   * @return \Amazon\Reports\Model\GetFeedSubmissionListResponse \Amazon\Reports\Model\GetFeedSubmissionListResponse
   *
   * @throws AmazonException
   */
  public function getFeedSubmissionList($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetFeedSubmissionListRequest) {
      $request = new \Amazon\Reports\Model\GetFeedSubmissionListRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetFeedSubmissionList($request));
    $response = \Amazon\Reports\Model\GetFeedSubmissionListResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportRequestListRequest request
   * or \Amazon\Reports\Model\GetReportRequestListRequest object itself
   * @see \Amazon\Reports\Model\GetReportRequestList
   * @return \Amazon\Reports\Model\GetReportRequestListResponse \Amazon\Reports\Model\GetReportRequestListResponse
   *
   * @throws AmazonException
   */
  public function getReportRequestList($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportRequestListRequest) {
      $request = new \Amazon\Reports\Model\GetReportRequestListRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetReportRequestList($request));
    $response = \Amazon\Reports\Model\GetReportRequestListResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportScheduleListByNextTokenRequest request
   * or \Amazon\Reports\Model\GetReportScheduleListByNextTokenRequest object itself
   * @see \Amazon\Reports\Model\GetReportScheduleListByNextToken
   * @return \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse
   *
   * @throws AmazonException
   */
  public function getReportScheduleListByNextToken($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportScheduleListByNextTokenRequest) {
      $request = new \Amazon\Reports\Model\GetReportScheduleListByNextTokenRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetReportScheduleListByNextToken($request));
    $response = \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportListByNextTokenRequest request
   * or \Amazon\Reports\Model\GetReportListByNextTokenRequest object itself
   * @see \Amazon\Reports\Model\GetReportListByNextToken
   * @return \Amazon\Reports\Model\GetReportListByNextTokenResponse \Amazon\Reports\Model\GetReportListByNextTokenResponse
   *
   * @throws AmazonException
   */
  public function getReportListByNextToken($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportListByNextTokenRequest) {
      $request = new \Amazon\Reports\Model\GetReportListByNextTokenRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetReportListByNextToken($request));
    $response = \Amazon\Reports\Model\GetReportListByNextTokenResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\ManageReportScheduleRequest request
   * or \Amazon\Reports\Model\ManageReportScheduleRequest object itself
   * @see \Amazon\Reports\Model\ManageReportSchedule
   * @return \Amazon\Reports\Model\ManageReportScheduleResponse \Amazon\Reports\Model\ManageReportScheduleResponse
   *
   * @throws AmazonException
   */
  public function manageReportSchedule($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\ManageReportScheduleRequest) {
      $request = new \Amazon\Reports\Model\ManageReportScheduleRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertManageReportSchedule($request));
    $response = \Amazon\Reports\Model\ManageReportScheduleResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportRequestCountRequest request
   * or \Amazon\Reports\Model\GetReportRequestCountRequest object itself
   * @see \Amazon\Reports\Model\GetReportRequestCount
   * @return \Amazon\Reports\Model\GetReportRequestCountResponse \Amazon\Reports\Model\GetReportRequestCountResponse
   *
   * @throws AmazonException
   */
  public function getReportRequestCount($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportRequestCountRequest) {
      $request = new \Amazon\Reports\Model\GetReportRequestCountRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetReportRequestCount($request));
    $response = \Amazon\Reports\Model\GetReportRequestCountResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
   ...
   * @param mixed $request array of parameters for \Amazon\Reports\Model\GetReportScheduleListRequest request
   * or \Amazon\Reports\Model\GetReportScheduleListRequest object itself
   * @see \Amazon\Reports\Model\GetReportScheduleList
   * @return \Amazon\Reports\Model\GetReportScheduleListResponse \Amazon\Reports\Model\GetReportScheduleListResponse
   *
   * @throws AmazonException
   */
  public function getReportScheduleList($request)
  {
    if (!$request instanceof \Amazon\Reports\Model\GetReportScheduleListRequest) {
      $request = new \Amazon\Reports\Model\GetReportScheduleListRequest($request);
    }
    
    $httpResponse = $this->invoke($this->convertGetReportScheduleList($request));
    $response = \Amazon\Reports\Model\GetReportScheduleListResponse::fromXML($httpResponse['ResponseBody']);
    $response->setResponseHeaderMetadata($httpResponse['ResponseHeaderMetadata']);
    return $response;
  }
        ...
        { 
          ...
          switch ($httpStatus) {
          	...
          	case 503:
		          ...
		          $errorResponse = \Amazon\Reports\Model\ErrorResponse::fromXML($response['ResponseBody']);
  ...
  private function performRequest($action, array $converted, $dataHandle = null) 
  {
    ...
    $responseHeaderMetadata = new \Amazon\Reports\Model\ResponseHeaderMetadata
    (
  ...
  private function configureCurlOptions($action, array $converted, $streamHandle = null) 
  {
    ...
    if ($requestType == RequestType::POST_UPLOAD) 
    {
      ...
      { 
        throw new AmazonException(array ('Message' => 'Missing stream resource.'));
      }
