...
/**
 * \Amazon\Reports\Model\ManageReportScheduleResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>ManageReportScheduleResult: \Amazon\Reports\Model\ManageReportScheduleResult</li>
...
class ManageReportScheduleResponse extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\ManageReportScheduleResponse
     * 
    ...
    {
        $this->fields = array (
        'ManageReportScheduleResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\ManageReportScheduleResult'),
    ...
    /**
     * Construct \Amazon\Reports\Model\ManageReportScheduleResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return \Amazon\Reports\Model\ManageReportScheduleResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\ManageReportScheduleResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct \Amazon\Reports\Model\ManageReportScheduleResponse from provided XML. 
     ...
     * @return \Amazon\Reports\Model\ManageReportScheduleResponse instance
     */
