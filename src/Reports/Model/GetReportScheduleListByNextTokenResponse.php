...
/**
 * \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetReportScheduleListByNextTokenResult: \Amazon\Reports\Model\GetReportScheduleListByNextTokenResult</li>
...
class GetReportScheduleListByNextTokenResponse extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse
     * 
    ...
    {
        $this->fields = array (
        'GetReportScheduleListByNextTokenResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\GetReportScheduleListByNextTokenResult'),
    ...
    /**
     * Construct \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse from provided XML. 
     ...
     * @return \Amazon\Reports\Model\GetReportScheduleListByNextTokenResponse instance
     */
