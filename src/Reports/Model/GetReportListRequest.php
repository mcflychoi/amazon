...
/**
 * \Amazon\Reports\Model\GetReportListRequest
 * 
 * Properties:
 * <ul>
 * 
...
class GetReportListRequest extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\GetReportListRequest
     * 
     ...
     * @return \Amazon\Reports\Model\GetReportListRequest instance
     */
    ...
    {
        $reportRequestIdList = new \Amazon\Reports\Model\IdList();
        $reportRequestIdList->setId($value['Id']);
        $this->fields['ReportRequestIdList']['FieldValue'] = $reportRequestIdList;
        return;
    }
