...
/**
 * \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetFeedSubmissionListByNextTokenResult: \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResult</li>
...
class GetFeedSubmissionListByNextTokenResponse extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse
     * 
    ...
    public function __construct($data = null)
    {
        $this->fields = array 
        (
        'GetFeedSubmissionListByNextTokenResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResult'),
    ...
    /**
     * Construct \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse from provided XML. 
     ...
     * @return \Amazon\Reports\Model\GetFeedSubmissionListByNextTokenResponse instance
     */
