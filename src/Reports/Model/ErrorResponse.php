...
/**
 * Amazon\Reports\Model\ErrorResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>Error: Amazon\Reports\Model\Error</li>
...
class ErrorResponse extends Model
{
    ...
    /**
     * Construct new Amazon\Reports\Model\ErrorResponse
     * 
    ...
    public function __construct($data = null)
    {
        $this->fields = array 
        (
            'Error' => array('FieldValue' => array(), 'FieldType' => '\Amazon\Reports\Model\Error'),
    ...
    /**
     * Construct Amazon\Reports\Model\ErrorResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Amazon\Reports\Model\ErrorResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\ErrorResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct Amazon\Reports\Model\ErrorResponse from provided XML. 
     ...
     * @return Amazon\Reports\Model\ErrorResponse  instance
     */
