...
/**
 * Amazon\Reports\Model\RequestReportResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>RequestReportResult: Amazon\Reports\Model\RequestReportResult</li>
...
class RequestReportResponse extends Model
{
    ...
    /**
     * Construct new Amazon\Reports\Model\RequestReportResponse
     * 
    ...
    public function __construct($data = null)
    {
        $this->fields = array 
        (
            'RequestReportResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\RequestReportResult'),
    ...
    /**
     * Construct Amazon\Reports\Model\RequestReportResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Amazon\Reports\Model\RequestReportResponse 
     */
    public static function fromXML($xml)
    {
        ...
        {
            return new \Amazon\Reports\Model\RequestReportResponse(($response->item(0))); 
        } 
        else 
        {
            throw new Exception ("Unable to construct Amazon\Reports\Model\RequestReportResponse from provided XML. 
     ...
     * @return Amazon\Reports\Model\RequestReportResponse instance
     */
