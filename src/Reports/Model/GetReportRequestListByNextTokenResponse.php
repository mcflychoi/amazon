...
/**
 * \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetReportRequestListByNextTokenResult: \Amazon\Reports\Model\GetReportRequestListByNextTokenResult</li>
...
class GetReportRequestListByNextTokenResponse extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse
     * 
    ...
    {
        $this->fields = array (
        'GetReportRequestListByNextTokenResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\GetReportRequestListByNextTokenResult'),
    ...
    /**
     * Construct \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse from provided XML. 
     ...
     * @return \Amazon\Reports\Model\GetReportRequestListByNextTokenResponse instance
     */
