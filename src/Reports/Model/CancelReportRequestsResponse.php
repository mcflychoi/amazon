...
/**
 * Amazon\Reports\Model\CancelReportRequestsResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>CancelReportRequestsResult: Amazon\Reports\Model\CancelReportRequestsResult</li>
...
class CancelReportRequestsResponse extends Model
{
    ...
    /**
     * Construct new Amazon\Reports\Model\CancelReportRequestsResponse
     * 
    ...
    public function __construct($data = null)
    {
        $this->fields = array 
        (
            'CancelReportRequestsResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\CancelReportRequestsResult'),
    ...
    /**
     * Construct Amazon\Reports\Model\CancelReportRequestsResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Amazon\Reports\Model\CancelReportRequestsResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\CancelReportRequestsResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct Amazon\Reports\Model\CancelReportRequestsResponse from provided XML. 
     ...
     * @return Amazon\Reports\Model\CancelReportRequestsResponse instance
     */
