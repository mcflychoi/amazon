...
/**
 * \Amazon\Reports\Model\GetFeedSubmissionCountResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetFeedSubmissionCountResult: \Amazon\Reports\Model\GetFeedSubmissionCountResult</li>
...
class GetFeedSubmissionCountResponse extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\GetFeedSubmissionCountResponse
     * 
    ...
    public function __construct($data = null)
    {
        $this->fields = array 
        (
            'GetFeedSubmissionCountResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\GetFeedSubmissionCountResult'),
    ...
    /**
     * Construct \Amazon\Reports\Model\GetFeedSubmissionCountResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return \Amazon\Reports\Model\GetFeedSubmissionCountResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\GetFeedSubmissionCountResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct \Amazon\Reports\Model\GetFeedSubmissionCountResponse from provided XML. 
     ...
     * @return \Amazon\Reports\Model\GetFeedSubmissionCountResponse instance
     */
