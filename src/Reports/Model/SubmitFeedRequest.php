...
/**
 * \Amazon\Reports\Model\SubmitFeedRequest
 * 
 * Properties:
 * <ul>
 * 
 ...
 * <li>MarketplaceIdList: \Amazon\Reports\Model\IdList</li>
...
class SubmitFeedRequest extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\SubmitFeedRequest
     * 
    ...
    {
    	self::$DEFAULT_CONTENT_TYPE = new ContentType(array('ContentType' => 'application/octet-stream'));
        ...
        (
            ...
            'MarketplaceIdList' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\IdList'),
            ...
            'ContentMd5' => array ('FieldValue' => null, 'FieldType' => 'string'),
     	    'ContentType' => array ('FieldValue' => self::$DEFAULT_CONTENT_TYPE, 'FieldType' => '\Amazon\Reports\Model\ContentType')      
        );
    ...
    private function verifySupportedContentType($supplied) 
    {
        if (!($supplied == self::$DEFAULT_CONTENT_TYPE)) {
    		throw new \Amazon\Reports\AmazonException(
                array(
     ...
     * @return \Amazon\Reports\Model\SubmitFeedRequest instance
     */
    ...
    {
    	$marketplaceIdList = new \Amazon\Reports\Model\IdList();
