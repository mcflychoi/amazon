...
/**
 * Amazon\Reports\Model\GetReportListResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetReportListResult: Amazon\Reports\Model\GetReportListResult</li>
...
class GetReportListResponse extends Model
{
    ...
    /**
     * Construct new Amazon\Reports\Model\GetReportListResponse
     * 
    ...
    public function __construct($data = null)
    {
        $this->fields = array 
        (
            'GetReportListResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\GetReportListResult'),
    ...
    /**
     * Construct Amazon\Reports\Model\GetReportListResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return Amazon\Reports\Model\GetReportListResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\GetReportListResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct Amazon\Reports\Model\GetReportListResponse from provided XML. 
     ...
     * @return Amazon\Reports\Model\GetReportListResponse instance
     */
