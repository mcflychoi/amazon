...
/**
 * \Amazon\Reports\Model\SubmitFeedResult
 * 
 * Properties:
 * <ul>
 * 
...
class SubmitFeedResult extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\SubmitFeedResult
     * 
    ...
    public function __construct($data = null)
    {
        $this->fields = array 
        (
            'FeedSubmissionInfo' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\FeedSubmissionInfo'),
        );
     ...
     * @return \Amazon\Reports\Model\SubmitFeedResult instance
     */
