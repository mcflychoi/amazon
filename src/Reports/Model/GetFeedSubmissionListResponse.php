...
/**
 * \Amazon\Reports\Model\GetFeedSubmissionListResponse
 * 
 * Properties:
 * <ul>
 * 
 * <li>GetFeedSubmissionListResult: \Amazon\Reports\Model\GetFeedSubmissionListResult</li>
...
class GetFeedSubmissionListResponse extends Model
{
    ...
    /**
     * Construct new \Amazon\Reports\Model\GetFeedSubmissionListResponse
     * 
    ...
    public function __construct($data = null)
    {
        $this->fields = array 
        (
            'GetFeedSubmissionListResult' => array('FieldValue' => null, 'FieldType' => '\Amazon\Reports\Model\GetFeedSubmissionListResult'),
    ...
    /**
     * Construct \Amazon\Reports\Model\GetFeedSubmissionListResponse from XML string
     * 
     * @param string $xml XML string to construct from
     * @return \Amazon\Reports\Model\GetFeedSubmissionListResponse 
     */
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new \Amazon\Reports\Model\GetFeedSubmissionListResponse(($response->item(0))); 
        } else {
            throw new \Exception ("Unable to construct \Amazon\Reports\Model\GetFeedSubmissionListResponse from provided XML. 
     ...
     * @return \Amazon\Reports\Model\GetFeedSubmissionListResponse instance
     */
